...
def filter(boxes, window_x=0.4, window_y=0.4, box_x=4, box_y=3, window_span=1.2, box_span=1.25):
    ...
    if BOX_VALID:
        ...
        for obj_box, obj_cls in zip(rec_list[0], rec_list[1]):
            ...
            (BOX_XYWHN[1] - BOX_XYWHN[3] / 2) < obj_box[1] < (BOX_XYWHN[1] + BOX_XYWHN[3] / 2) and obj_box[2]*obj_box[3] > 0.003:
...
class CsvWriter:
    def __init__(self,car_model_buffer,plane_model_buffer):
...
class Nav:
    def __init__(self):
        ...
        self.is_collecte = False
        self.collecte_image = None


        
        self.image_lock = threading.Lock()

        self.plane_model = Model("/home/tta/Project_ws/src/rmep_nav/scripts/model/720car-2.pt",
        model_input_path='/home/tta/Project_ws/src/rmep_nav/scripts/image_from_flight/',
        pic_recognize_count=16)

        self.car_model = Model("/home/tta/Project_ws/src/rmep_nav/scripts/model/720car-1.pt",
        ...
        self.image_collecte = Thread(target=self.collecte_pictures)
        self.image_collecte.start()
        ...
        while True:
            if self.is_collecte:
                ...
                intrinsic = np.array([[624.302683276108, 0, 632.376721286788],
                                ...
                                [0, 0, 1]])
                corrected_image = cv2.undistort(self.collecte_image, intrinsic, dist_coeffs)     
    ...
    def nav_for_projecte(self):
        ...
        self.is_collecte = True

        self.go_picture_point(2+bioas,2.75,0,'2-9')
        self.go_picture_point(3.5+bioas,2.75,0,'2-10')
        self.go_picture_point(4.75+bioas,2.75,0,'2-11')
        self.go_picture_point(5.75+bioas,2.75,0,'2-12')
        ...
        self.go_picture_point(2.0+bioas,0.45,0,'1-9')

        self.is_collecte = True

        self.go_picture_point(3.5+bioas,0.45,0,'1-10')
        self.go_picture_point(4.75+bioas,0.45,0,'1-11')
        self.go_picture_point(5.75+bioas,0.45,0,'1-12')
    ...
    def camera_cb(self, msg):
        ...
        self.collecte_image = self.cv_bridge.imgmsg_to_cv2(msg,"bgr8")
    ...
    def finish(self):
        ...
        write_path = f'/mnt/result{csv_time}.csv'
        ...
        try:
            self.csv_writer.write(f'/home/tta/Project_ws/src/rmep_nav/scripts/model_result/result{csv_time}.csv')
