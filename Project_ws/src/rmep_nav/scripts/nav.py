...
class nav:
    ...
    def nav_for_projecte(self):
        ...
        d= MoveBaseGoal()
        e= MoveBaseGoal()
        a.target_pose.pose.position.x=-2.3662530420082364
        a.target_pose.pose.position.y=-1.4237877176006979
        b.target_pose.pose.position.x=-5.753651985413156
        b.target_pose.pose.position.y=5.199359159257416
        c.target_pose.pose.position.x=-3.661306982422831
        c.target_pose.pose.position.y=6.2617170561320625
        d.target_pose.pose.position.x=-1.2312555812612591
        d.target_pose.pose.position.y=0.7853096241048232
