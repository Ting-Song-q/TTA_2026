...
def filter_boxes_advanced(boxes,span_factor=1.25,layer=1,min_factor=0.2):
    CARD_SPAN_X = 4
    CARD_SPAN_Y = 3
...
class Model:
    ...
    def recognize(self,model_input):
        ...
        ret,good_num,bad_num = filter_boxes_advanced(res)
...
class Nav:
    def __init__(self):
        ...
        self.csv_writer = CsvWriter(self.car_model.model_output_buffer,
                            ...
                            output_file_path=f'/home/tta/Project_ws/src/rmep_nav/scripts/model_result/result{self.csv_time}.csv')
