...
if __name__=='__main__':
        ...
        try:
            csv_writer.write(f"/home/tta/Project_ws/src/rmep_nav/scripts/model_result/result{csv_time}.csv")
            print(f"SAVE AS /home/tta/Project_ws/src/rmep_nav/scripts/model_result/result{csv_time}.csv")
        except Exception as ce:
            print(f"OH,好像发生了一个错误在写入本地csv文件中",ce)
        
        try:
            csv_writer.write(write_path)
