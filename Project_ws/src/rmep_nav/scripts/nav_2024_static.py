...
class Nav:
    ...
    def nav_for_projecte(self):
        ...
        # self.align_wall()
        self.go_linear_x(0.15,2.45)
        rospy.sleep(1)
        self.turn_ang(0.5,math.pi/2)
        rospy.sleep(1)
        # self.align_wall()

        self.go_linear_x(0.15,0.75+0.63+0.75)
        rospy.sleep(1)
        self.take_picture('2-9')

        self.go_linear_x(0.15,1.45)
        rospy.sleep(1)
        self.take_picture('2-10')

        self.go_linear_x(0.15,1.2)
        rospy.sleep(1)
        self.take_picture('2-11')

        self.go_linear_x(0.15,0.95)
        rospy.sleep(1)
        self.take_picture('2-12')
        ...
        self.go_linear_x(-0.15,1.45)
        rospy.sleep(1)
        self.take_picture('1-12')

        self.go_linear_x(-0.15,0.95)
        rospy.sleep(1)
        self.take_picture('1-11')

        self.go_linear_x(-0.15,1.2)
        rospy.sleep(1)
        self.take_picture('1-10')

        self.go_linear_x(-0.15,1.45)
        rospy.sleep(1)
        self.take_picture('1-9')

        #
        self.car_model.CAR_RECOGNIZE = True
        #

        self.go_linear_x(-0.15,0.75+0.63+0.55)
